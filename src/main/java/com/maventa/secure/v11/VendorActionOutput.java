...
public class VendorActionOutput  implements java.io.Serializable {
    ...
    private VendorAction[] vendor_actions;
     ...
     */
    public VendorAction[] getVendor_actions() {
        return vendor_actions;
    }
     ...
     */
    public void setVendor_actions(VendorAction[] vendor_actions) {
        this.vendor_actions = vendor_actions;
    }
