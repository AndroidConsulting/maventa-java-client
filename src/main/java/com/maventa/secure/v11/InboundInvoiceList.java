...
public class InboundInvoiceList  implements java.io.Serializable {
    ...
    private InboundInvoiceListItem[] items;
     ...
     * @return items
     */
    public InboundInvoiceListItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(InboundInvoiceListItem[] items) {
        this.items = items;
    }
