...
public class MaventaServiceLocator extends org.apache.axis.client.Service implements MaventaService {
    ...
    public MaventaApiPort getMaventaApiPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MaventaApiBindingStub _stub = new MaventaApiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MaventaApiPort.class.isAssignableFrom(serviceEndpointInterface)) {
                MaventaApiBindingStub _stub = new MaventaApiBindingStub(new java.net.URL(MaventaApiPort_address), this);
                _stub.setPortName(getMaventaApiPortWSDDServiceName());
                return _stub;
            }
        }
