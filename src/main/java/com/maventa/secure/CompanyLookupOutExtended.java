...
public class CompanyLookupOutExtended  implements java.io.Serializable {
    ...
    private com.maventa.secure.ElectronicInvoiceAddress[] edis;
    ...
    public CompanyLookupOutExtended(
           ...
           com.maventa.secure.ElectronicInvoiceAddress[] edis,
     ...
     * @return edis
     */
    public com.maventa.secure.ElectronicInvoiceAddress[] getEdis() {
        return edis;
    }
     ...
     * @param edis
     */
    public void setEdis(com.maventa.secure.ElectronicInvoiceAddress[] edis) {
        this.edis = edis;
    }
